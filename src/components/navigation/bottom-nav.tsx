...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Primary" className="fixed inset-x-0 bottom-0 z-40 mx-auto max-w-[430px] border-t bg-[color:var(--surface)]/92 px-4 pb-[max(10px,env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl md:absolute">
